function LD_dynamic_MAE_v10(subject, session, debug)
...
ex.stim.gaborWDeg = 6; 
ex.stim.distFromFixDeg = 3+ex.stim.gaborWDeg/2;%3;%2; %1.5 %each grating edge 1.5 deg horizontal away from fixation (grating center 6 deg away)
