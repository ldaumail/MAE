function [img] = makeSquSineGrating(ih,iw,freq,angle,phase,mean,amp,pixPerDeg,r1,r2,bcolor);
...
img = sign(sin(freq*2*pi/iw*(X.*sin(angle*2*pi/360)+Y.*cos(angle*2*pi/360))-phase*2*pi/360));% make sine wave, values range from -1 and 1
