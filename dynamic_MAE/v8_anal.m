...
avgConditions = {sprintf('%s\\newline%s\\newline%s\n','Low Contrast',' up'), sprintf('%s\\newline%s\\newline%s\n','Low Contrast',' down'), ...
    sprintf('%s\\newline%s\\newline%s\n','Mid Contrast',' up'),sprintf('%s\\newline%s\\newline%s\n','Mid Contrast',' down'), ...
   sprintf('%s\\newline%s\\newline%s\n','High Contrast',' up'),sprintf('%s\\newline%s\\newline%s\n','High Contrast',' down'),... % sprintf('%s\\newline%s\\newline%s\n','Inducer bar lum does not',' match bg single (Control)'),
    'No inducer'}; 
...
mkdir(plotdir);
saveas(gcf,strcat(plotdir, sprintf('proportion_percepts_across_conditions_%s_%s_sp6_test4.png', name, version)));
